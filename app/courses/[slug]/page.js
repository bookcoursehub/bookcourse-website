    ...
    <>
      <section className="hero-bg text-white">
        <div className="container-px mx-auto max-w-7xl grid lg:grid-cols-2 gap-10 items-center py-16 lg:py-20">
          <div>
            <Link href="/courses" className="text-sm text-ink-300 hover:text-white transition-colors">← Back to all courses</Link>
            <span className="inline-flex items-center gap-2 mt-5 px-3 py-1.5 bg-accent-500 text-white text-[11px] uppercase tracking-[0.18em] font-bold rounded">{course.category}</span>
            ...
            <div className="mt-7 flex flex-wrap gap-3 items-center">
              <div className="px-5 py-3 rounded-lg bg-white/10 border border-white/20">
          ...
          <div className="relative">
            <img src={course.image} alt={course.title} className="relative w-full h-[420px] object-cover rounded-lg shadow-2xl border-2 border-accent-500" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container-px mx-auto max-w-7xl grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 prose-brand">
            ...
            <h2>Outcomes and career routes</h2>
            <ul>
        ...
        <section className="py-20 bg-ink-100 border-t border-ink-200">
          <div className="container-px mx-auto max-w-7xl">
            <div className="text-center max-w-2xl mx-auto mb-10">
              ...
              <h2 className="section-heading mt-3">Related courses</h2>
            </div>
